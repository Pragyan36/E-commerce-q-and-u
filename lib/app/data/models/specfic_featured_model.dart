...
class SpecificFeatured {
  bool? error;
  SpecificFeaturedData? data;
  String? msg;

  SpecificFeatured({this.error, this.data, this.msg});

  SpecificFeatured.fromJson(Map<String, dynamic> json) {
    error = json['error'];
    data = json['data'] != null
        ? SpecificFeaturedData.fromJson(json['data'])
        : null;
    msg = json['msg'];
  }
...
class SpecificFeaturedData {
  ...
  String? createdAt;
  String? updatedAt;
  List<FeaturedProductsList>? featuredProducts;

  SpecificFeaturedData(
      {this.id,
      this.title,
      this.count,
      this.publishStatus,
  ...
  SpecificFeaturedData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
    count = json['count'];
    ...
    if (json['featured_products'] != null) {
      ...
      json['featured_products'].forEach((v) {
        featuredProducts!.add(FeaturedProductsList.fromJson(v));
      });
    }
  }
...
class FeaturedProductsList {
  ...
  FeaturedProductsList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    slug = json['slug'];
