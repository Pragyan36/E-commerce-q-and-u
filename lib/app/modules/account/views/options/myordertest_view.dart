...
class MyTestOrderView extends StatefulWidget {
  final bool isFromPurchaseView;

  const MyTestOrderView({
    super.key,
    required this.isFromPurchaseView,
  });

  @override
  State<MyTestOrderView> createState() => _MyOrderTestViewState();
}

class _MyOrderTestViewState extends State<MyTestOrderView> {
                          ...
                          ? GestureDetector(
                              onTap: () {
                                final snackBar = SnackBar(
                                    content: Text(
                                        data.refundRejectReason.toString()));
