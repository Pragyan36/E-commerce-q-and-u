...
class MyOrderTestView extends StatefulWidget {
  ...
  @override
  State<MyOrderTestView> createState() => _MyOrderViewState();
}

class _MyOrderViewState extends State<MyOrderTestView> {
          ...
          children: [
              ...
              children: [
                Row(
                  children: [
                    ...
                    //     color: data.paymentStatus == 1 || data.statusvalue == 'DELIVERED'
                    //         ? Colors.green // Change color to green for paid or delivered
                    //         : Colors.red, // Change color to red for unpaid or not delivered
                    //   ),,
                    // ),
                    // SizedBox(width: 8) // Add some space between the text and the icon
                    // // Icon with border
                    // // Icon with square border and rounded corners
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: data.paymentStatus == 1 ||
                                  data.statusvalue == 'DELIVERED'
                              ? Colors
                                  .green // Change border color to green for paid or delivered
                              : Colors
                                  .green, // Change border color to red for unpaid or not delivered
                          width: 2,
                        ),
                      ),
                      child: Stack(
                        ...
                        children: [
                          data.paymentStatus == 1 ||
                                  data.statusvalue == 'SHPIED'
                              ? const Icon(
                                  Icons.check,
                                  size: 20,
                                  color: Colors
                                      .green, // Change icon color to green for paid or delivered
                                )
                              : const Icon(
                                  Icons.error_outline,
                                  size: 20,
                                  color: Colors
                                      .green, // Error icon color for unpaid or not delivered
                                ),
                          Positioned(
                            top: -16,
                            child: Text(
                              data.paymentStatus == 1 ||
                                      data.statusvalue == 'DELIVERED'
                                  ? 'Paid' // Text to display for paid or delivered orders
                                  : 'Unpaid', // Text to display for unpaid or not delivered orders
                ...
                Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: subtitleStyle.copyWith(
                          color: AppColor.mainClr, fontWeight: FontWeight.bold),
                    ),
                    const SizedBox(
                      height: 5,
                    ),
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  'Total: ${thousandSepretor.format(totalprice)}',
                  style: subtitleStyle.copyWith(
                      color: Colors.grey, fontWeight: FontWeight.bold),
                )
              ],
          ...
          children: [
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Text(
                  data.statusvalue == null ? '' : data.statusvalue.toString(),
                  style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.w400,
                      fontSize: 12),
