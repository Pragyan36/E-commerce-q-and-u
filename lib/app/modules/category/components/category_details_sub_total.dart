...
import '../../department/controllers/department_controller.dart';
import '../../login/controllers/login_controller.dart';
import '../../product_detail/views/product_detail_view.dart';
import '../../wishlist/controllers/wishlist_controller.dart';

class SecondCategory extends GetView<DepartmentController> {
  SecondCategory({this.slug, this.title, Key? key}) : super(key: key);
                ...
                () => loginController.loading.value
                    ...
                    : Column(
                        children: [
                          ...
                          // _setIndex0Data(),
                          /*For Products Body*/
                          loginController.products.isNotEmpty
                              ? Column(
                                  children: [
                              ...
                              : const NoDataView(text: "No product found")
                        ],
                      ),
              ),
              // _buildTypeSlider(),
                      ...
                      onPressed: () async {
                        ...
                        if (loginController
                          ...
                          loginController.childCategoryData[index]['products']
                              .forEach(
                            (v) => loginController.products.add(
                              Products.fromJson(v),
                            ),
                          );
