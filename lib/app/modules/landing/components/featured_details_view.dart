...
class _FeaturedDeatilsViewState extends State<FeaturedDeatilsView> {
  ...
  // fetchall() async {
  //   await controller.fetchSpecificFeaturedProducts(widget.id);
  // }

  @override
  Widget build(BuildContext context) {
    // print(controller.specificfeaturedList.length.toString());
    // controller.fetchSpecificFeaturedProducts(widget.id);

    return Scaffold(
      appBar: CustomAppbar(title: widget.title),
      body:
          //  Text(controller.specificfeaturedList.toString())
          Obx(
        () => controller.specificloading.isFalse
            ? GridView.builder(
